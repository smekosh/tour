...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <p>You will need to present a valid US federal or state-issued picture ID, such as a driver's license, passport or state-issued ID. A non-US citizen is required to provide a passport. The building security guards cannot accept other documents nor waive these requirements.</p>
