...
{block name="title"}
    <title>About | VOA Studio Tour</title>
{/block}
...
<ul>
    ...
    <li>Commercial Tour Companies: To find out how to include VOA in your tour route, please call (202) 203-4990 or e-mail us (tickets@voanews.com).</li>
</ul>

<h4>Reservations:</h4>

<ul>
    <li>For groups of 5 or more visitors, we ask that you please call to arrange a private tour (202) 203-4990. Groups are limited to 20 visitors. </li>
    <li>Reservations are recommended and can be made online or by phone (202) 203-4990.</li>
